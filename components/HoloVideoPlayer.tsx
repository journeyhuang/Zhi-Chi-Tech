...
const HoloVideoPlayer: React.FC = () => {
  return (
    <div className="relative w-full max-w-md mx-auto lg:mx-0">
      <div className="relative mx-auto w-[260px] sm:w-[300px] aspect-[3/4]">
        <div className="relative h-full w-full rounded-[2.5rem] overflow-hidden border border-white/10 bg-white/5">
        <video
        ...
        <div className="absolute top-6 left-6 z-20 flex items-center gap-2 rounded-full bg-black/40 px-3 py-1 text-xs font-semibold text-white backdrop-blur">
